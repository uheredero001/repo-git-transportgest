...
<html lang="en">
  <head>
    ...
    <title> Cambiar Hora fin de Punto Descarga</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el punto al que quiere cambiar la hora de direccion:
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-lg btn-success" value="Cambiar Direccion"></input>
                </div>
          </form>
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarDireccionPuntoDescarga.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
