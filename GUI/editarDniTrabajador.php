...
<html lang="en">
  <head>
    ...
    <title> Cambiar Dni de Trabajador</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el trabajador al que quiere cambiar el dni:
                ...
                <div class="form-group">
                    Indique el nuevo dni del trabajador (letra en mayuscula):
                    <input id="dni" name="dni" class="form-control"></input>
                </div>
                <div class="form-group">
                    <input type="submit" class="btn btn-lg btn-success" value="Cambiar Dni"></input>
                </div>
          </form>
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarDniTrabajador.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
