...
<html lang="en">
  <head>
    ...
    <title> Cambiar Puesto de Trabajador</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el trabajador al que quiere cambiar el puesto:
                ...
                <div class="form-group">
                    Indique el nuevo puesto del trabajador:
                    <input id="puesto" name="puesto" class="form-control"></input>
                </div>
                <div class="form-group">
                    <input type="submit" class="btn btn-lg btn-success" value="Cambiar Puesto"></input>
                </div>
          </form>
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarPuestoTrabajador.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
