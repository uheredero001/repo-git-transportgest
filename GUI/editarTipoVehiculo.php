...
<html lang="en">
  <head>
    ...
    <title> Cambiar Tipo de Vehiculo</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el vehiculo al que quiere cambiar el tipo:
                ...
                <div class="form-group">
                  Indique el nuevo tipo de vehiculo:
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-lg btn-success" value="Cambiar Tipo"></input>
                </div>
          </form>
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarTipoVehiculo.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
