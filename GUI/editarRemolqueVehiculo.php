...
<html lang="en">
  <head>
    ...
    <title> Cambiar Remolque de Vehiculo</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el vehiculo al que quiere cambiar el remolque:
                ...
                <div class="form-group">
                    Indique el nuevo remolque del vehiculo:
                    <input type="text" id="remolque" name="remolque" class="form-control"></input>
                </div>
                <div class="form-group">
                    <input type="submit" class="btn btn-lg btn-success" value="Cambiar Remolque"></input>
                </div>
          </form>
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarRemolqueVehiculo.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
