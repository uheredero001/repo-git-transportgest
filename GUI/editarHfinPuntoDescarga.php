        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                ...
                <div class="form-group">
                    Indique la nueva hora de finalizacion del punto de descarga:
                    <input type="time" id="hinicio" class=" form-control" name="hinicio" value="00:00" required>
                </div>
                <div class="form-group">
                    <input type="submit" class="btn btn-lg btn-success" value="Cambiar Hora Finalizacion"></input>
                </div>
          </form>
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarHfinPuntoDescarga.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
