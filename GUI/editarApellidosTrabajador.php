...
<html lang="en">
  <head>
    ...
    <title> Cambiar Apellidos de Trabajador</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el trabajador al que quiere cambiar los apellidos:
                ...
                <div class="form-group">
                    Indique los nuevos apellidos del trabajador:
                    <input id="apellidos" name="apellidos" class="form-control"></input>
                </div>
                <div class="form-group">
                    <input type="submit" class="btn btn-lg btn-success" value="Cambiar Apellidos"></input>
                </div>
          </form>
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarApellidosTrabajador.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
