...
<html lang="en">
  <head>
    ...
    <title> Cambiar Apellidos Usuario</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el usuario al que quiere cambiar los apellidos:
                ...
                <div class="form-group">
                    Indique los nuevos apellidos del ususario:
          ...
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarApellidosUsuario.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
