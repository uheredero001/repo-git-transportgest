...
<html lang="en">
  <head>
    ...
    <title> Cambiar Nombre de Trabajador</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el trabajador al que quiere cambiar el nombre:
                ...
                <div class="form-group">
                    Indique el nuevo nombre del trabajador:
          ...
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarNombreTrabajador.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
