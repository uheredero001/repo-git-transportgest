...
<html lang="en">
  <head>
    ...
    <title> Cambiar Carga4 de Viaje Predeterminado</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el viaje al que quiere cambiar la carga4:
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-lg btn-success" value="Cambiar Carga4"></input>
                </div>
          </form>
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarCarga4ViajePredeterminado.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
