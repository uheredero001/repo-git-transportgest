...
<html lang="en">
  <head>
    ...
    <title> Cambiar Telefono de Trabajador</title>
  </head>
        ...
        <div class="col-sm-4" align="center">
          ...
          <form method="post">
              <div class="form-group">
                  Seleccione el trabajador al que quiere cambiar el telefono:
                ...
                <div class="form-group">
                    Indique el nuevo telefono del trabajador:
                    <input id="telefono" name="telefono" class="form-control"></input>
                </div>
                <div class="form-group">
          ...
          <?php
            include "/Applications/MAMP/htdocs/transportgest/LOGICA/editarTelefonoTrabajador.php";
           ?>
        </div>
        <div class="col-sm-4"></div>
      </div>
